        ...
        <div className="sm:w-3/4">
          <div className="flex flex-col gap-8 sm:gap-4">
            <p>
              ...
              platform boasts a diverse array of products, ranging from the
              latest tech gadgets to timeless fashion staples, ensuring
            ...
            <p>
              ...
              alike. From household essentials to niche hobby supplies, we
              strive to cater to every interest and preference. Explore our
              intuitive interface to discover an extensive range of categories,
              each offering a carefully curated collection of items handpicked
            ...
            <p>
              ...
              your browsing and purchasing journey, making it easier than ever
              to find exactly what you&apos;re looking for. Whether you&apos;re
              a seasoned online shopper or new to the world of ecommerce, our
              intuitive interface and responsive customer support ensure a
              seamless experience from start to finish.
            </p>
            <p>
              Join us today and unlock a world of endless possibilities. From
              free delivery to a diverse selection of products, chop is your
              one-stop destination for all your shopping needs. Start exploring
              now and experience the convenience of online shopping at its
              finest.
            </p>
          </div>
        </div>
